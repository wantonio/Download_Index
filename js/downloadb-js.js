angular.module('downloadIndex', ['ngAnimate'], function(){
    ...
    $scope.productCat = [{
        ...
        /*-----end of product-------*/
        {
            ...
            featured: "yes",
            code: "DPASQL",
            name: "Database Performance Analyzer (Formerly Confio Ignite) for SQL Server®",
        ...
        /*-----end of product-------*/
        {
            ...
            featured: "no",
            code: "DPAO",
            name: "Database Performance Analyzer (Formerly Confio Ignite) for Oracle®",
        ...
        /*-----end of product-------*/
        {
            ...
            featured: "no",
            code: "DPADB2",
            name: "Database Performance Analyzer (Formerly Confio Ignite) for DB2®",
        ...
        /*-----end of product-------*/
        {
            ...
            featured: "no",
            code: "DPASYB",
            name: "Database Performance Analyzer (Formerly Confio Ignite) for Sybase®",
